...
public class FajarReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Intent buttonIntent = new Intent(context, OkButtonFajar.class);
        buttonIntent.putExtra("notificationId", 101);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, CHANNEL_ID)
               ...
               // .setContentIntent(pendingIntent)
                ...
                .setContentText("It's Fajar Time!")
