package com.codex.namazdiary.MagribReceiver;
...
public class MagribReceiver extends BroadcastReceiver {

    @Override
    public void onReceive(Context context, Intent intent) {

        NotificationManager notificationManager = (NotificationManager) context.getSystemService(NOTIFICATION_SERVICE);
        Intent buttonIntent = new Intent(context, OkButtonMagrib.class);
        buttonIntent.putExtra("notificationId", 104);

        String CHANNEL_ID = "Channel_id_4";
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, CHANNEL_ID)
                ...
                .setContentText("It's Magrib Time!")
