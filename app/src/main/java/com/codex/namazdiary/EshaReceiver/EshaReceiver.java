...
public class EshaReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Intent buttonIntent = new Intent(context, OkButtonEsha.class);
        buttonIntent.putExtra("notificationId", 105);

        String CHANNEL_ID = "Channel_id_5";
